...
::: {.incremental}
 - [LearnGala](https://www.learngala.com/): [Example](https://www.learngala.com/cases/jalapenos)
 - [OERCommons (Open Author)](https://oercommons.org/): [More info](https://oercommons.org/authoring-overview)
 - [Pressbooks](https://pressbooks.com/): [Example](https://integrations.pressbooks.network/webliteracy/)
 - [Manifold](https://manifoldapp.org/): [Example](https://manifold.open.umn.edu/projects/cornerstone2nd)
 - [PreTeXt](https://pretextbook.org/)/[Plus](https://pretext.plus/): [Example](https://runestone.academy/ns/books/published/PTXSB/sample-book.html)
 - [Quarto](https://quarto.org/): [Examples](https://jjallaire.github.io/hopr/)
:::
...
::: {.incremental}
 - [Jupyter](https://jupyter.org/): [More info](https://jupyter.org/try)
 - [Observable](https://observablehq.com/): [Example](https://observablehq.com/d/894758716da3f579)
 - [Marimo](https://marimo.io/): [Example](https://molab.marimo.io/notebooks/nb_g86XM32SPLfeAzs8egFKmL)
:::
...
[Posit Connect Cloud](https://connect.posit.cloud/): <https://connect.posit.cloud/>

::: {.incremental}
 - Pro: Free
 - Pro: Easiest publishing solution
 - Pro: Great for students sharing work
 - Con: Does not share files (**_non-adaptable_**)
:::

. . .

![](images/posit-publish.png){width="80%" fig-align="center"}

## Publishing: Option #2

[GitHub/GitHub Pages](https://github.com): <https://github.com>

::: {.incremental}
 - Pro: Free
 - Pro: Files are accessible (**_adaptable_**)
 - Con: More complicated setup (some `git` knowledge)
:::

. . .

[Detailed instructions](https://quarto.org/docs/publishing/github-pages.html)
